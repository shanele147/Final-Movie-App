...
import "./LogIn.css";
import Modal from "../../components/Modal/WelcomeLogin";
  ...
  return (
    <div className="container mt-5 mb-5 logIn-form">
      <div className="d-flex flex row g-0 justify-content-center">
        <div
          className={
            isModalShow ? "col-md-6 mt-3 mb-3 hide" : "col-md-6 mt-3 mb-3"
          }
        >
          <div className="card card1 p-3">
            ...
            <div className="input-field d-flex flex-column mt-3">
              ...
              ></input>
              <button
                className="mt-4 btn btn-dark d-flex justify-content-center align-items-center"
                onClick={onLogin}
              >
                Login
              </button>
      ...
      <Modal isShow={isModalShow} user={user} />
    </div>
  );
}
