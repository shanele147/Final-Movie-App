...
function HeroSlider(props) {
        ...
        const filerMovies = nowPlaying && nowPlaying.filter((movie) => movie.vote_average > 7);
                    ...
                    >
                        <div className="overlay">
                            <div className="content-container">
                                ...
                                <br></br>
                                <p>Release: <span style={{ fontWeight: "bold", color: "#FB9039" }}>{release_date}</span></p>
                                <div><button className="btn-view-more" onClick={() => onViewMore(movieType, id)}>View more</button></div>
                            </div>
                        </div>
                    </div>
                </>
